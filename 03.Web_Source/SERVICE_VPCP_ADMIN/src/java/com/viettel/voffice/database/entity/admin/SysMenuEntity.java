...
public class SysMenuEntity {
    ...
    public SysMenuEntity(Long id, Long parent_id, String name, String url_page_link, String iconsclass, String description, int active, int showallpeople, int isleaf) {
        this.id = id;
