...
getClassIconMenuChildrenEx = function(menuType, url) {
	...
	case 13://Tra cuu van ban
		...
		break;
	case 12://Ban hanh
		classIcon = "menu-icon fa fa-clone";
		break;
...
createNotifys = function() {
	...
	if (typeof lstNotify === 'undefined' || lstNotify == null || lstNotify.length == 0) {
		...
		* @since 17/08/2016
		*/
		html = '<div class="itemdiv dialogdiv"><div class="user"><img src="/Share/img/default-avatar.png"></img></div><div class="body"><div class="text orange">Currently without notice!</div></div></div>';
	...
	for (var i = 0; i < lstNotify.length; i++) {
		...
		if (notify.content != null && notify.content != undefined) {
			...
			html = html + '<div class="text">Sent handling</div>';
		}
