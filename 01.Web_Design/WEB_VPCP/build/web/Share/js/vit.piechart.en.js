var VitxPieChart = {
	...
	createDataDocIn: function() {
		...
		//Van ban dang xu ly
		var dangXuLy = {};
		dangXuLy.label = "Processing";//"Đang xử lý";
		...
		var qhcht = {};
		qhcht.label = "Processed";//"Đã xử lý";
	...
	createDataDocOut: function() {
		//Van ban cho xu ly
		var choXuLy = {};
		choXuLy.label = "Pending";//"Chờ xử lý";
